...
namespace mm {
	...
	RubiksCubeModel_v1::Color RubiksCubeModel_v1::Cube::GetFaceColor(Face eFace) const
	{
		return faces_[eFace];
	}
	...
	*/
	...
	void RubiksCubeModel_v1::loadAllTextures()
	{
	...
	void RubiksCubeModel_v1::loadTexture(int nId, GLuint* texture)
	{
		// bitmap handle
		HBITMAP hBMP;
	...
	GLuint RubiksCubeModel_v1::getTextureID(Color color)
	{
	...
	string RubiksCubeModel_v1::RubiksCubeSolver::solve(int& solutionSteps)
	{
		solutionSteps_ = 0;
		solution_ = "";
